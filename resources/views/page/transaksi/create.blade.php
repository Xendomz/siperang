        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <form action="{{ route('transaksi.store') }}" class="needs-validation" novalidate=""
                                id="form" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="mb-3">
                                                                    ...
                                                                    <select name="barang" class="form-control select2"
                                                                        ...
                                                                        @foreach ($barangs as $barang)
                                                                            <option value="{{ $barang->id }}"
                                                                                {{ intval($old_barang['barang']) == $barang->id ? 'selected' : '' }}>
                                                        ...
                                                        <div class="col-md-3 my-2">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="number" class="form-control" min="0"
                                                                    id="qty" placeholder="0" name="qty" required>
                                                                <div class="invalid-feedback">
                                                                    Please fill Quantity
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="diskon" placeholder="0"
                                                name="diskon" min="0" value="{{ old('diskon') }}">
                                        </div>
                                    </div>
                                </div>
